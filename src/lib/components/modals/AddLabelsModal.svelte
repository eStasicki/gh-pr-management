      ...
      <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
        ...
        <button
          ...
          class="px-4 py-2 {showResults
            ...
            : 'bg-green-600 text-white rounded-lg font-semibold cursor-pointer transition-all duration-300 hover:bg-green-700'} disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {showResults ? t.confirm : t.add_labels}
        </button>
      </div>
    {/if}
  </div>
