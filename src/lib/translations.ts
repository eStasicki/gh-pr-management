...
export const translations: Translations = {
  pl: {
    ...
    settings_loading_error: "Błąd podczas ładowania ustawień",
    settings_saved_success: "Ustawienia zostały zapisane pomyślnie!",
    settings_save_error: "Błąd podczas zapisywania ustawień. Spróbuj ponownie.",
    demo_mode_disabled: "Tryb demo został wyłączony",
    demo_mode_enabled: "Tryb demo został włączony - 50 przykładowych PR",
    demo_mode_error: "Błąd podczas zmiany trybu demo",
    demo_mode_description:
      "Tryb demo pozwala na testowanie aplikacji z przykładowymi danymi bez konieczności konfiguracji GitHub API.",
    ...
    projects_management: "Zarządzanie projektami",
    select_project: "Wybierz projekt",
    active_project: "Aktywny projekt",
    add_new_project: "Dodaj nowy projekt",
    project_name: "Nazwa projektu",
    project_name_placeholder: "Mój projekt",
    rename_project: "Zmień nazwę projektu",
    delete_project: "Usuń projekt",
    delete_project_confirm: "Czy na pewno chcesz usunąć projekt '{name}'?",
    switch_project_title: "Przełączanie projektu",
    switch_project_message: "Czy chcesz przeładować dane dla nowego projektu?",
    switch_and_reload: "Tak, przeładuj dane",
    switch_only: "Nie, tylko zmień konfigurację",
    ...
    project_switched: "Przełączono na projekt '{name}'",
    no_projects: "Brak projektów",
    create_first_project: "Utwórz swój pierwszy projekt",
    cannot_delete_last_project: "Nie można usunąć ostatniego projektu",
    cannot_delete_active_project: "Nie można usunąć aktywnego projektu",
    project_name_required: "Nazwa projektu jest wymagana",
    project_name_too_long: "Nazwa projektu jest za długa (max 100 znaków)",
    project_already_exists: "Projekt o tej nazwie już istnieje",
    edit_project: "Edytuj projekt",
    current_project: "Bieżący projekt",
    switch_project: "Przełącz projekt",
    set_as_active: "Ustaw jako aktywny",
    switch_with_reload: "Przełącz",
    switch_and_reload_description: "Przeładuje PR-y, labels i wyczyści cache",
    switch_only_description: "Zmieni tylko konfigurację bez przeładowania",
    delete_project_warning: "Uwaga! Usuwanie projektu",
    delete_project_warning_description:
      "Ta akcja jest nieodwracalna. Wszystkie dane projektu zostaną trwale usunięte.",
    delete_confirmation_label: "Potwierdź usunięcie",
    delete_confirmation_help:
      "Wpisz 'DELETE' aby potwierdzić usunięcie projektu",
    delete_confirmation_required:
      "Musisz wpisać 'DELETE' aby potwierdzić usunięcie",
  },
  en: {
    ...
    demo_mode_disabled: "Demo mode has been disabled",
    demo_mode_enabled: "Demo mode has been enabled - 50 sample PRs",
    demo_mode_error: "Error changing demo mode",
    demo_mode_description:
      "Demo mode allows testing the application with sample data without GitHub API configuration.",
    ...
    switch_project_title: "Switching project",
    switch_project_message: "Do you want to reload data for the new project?",
    switch_and_reload: "Yes, reload data",
    switch_only: "No, just change configuration",
    ...
    cannot_delete_last_project: "Cannot delete the last project",
    cannot_delete_active_project: "Cannot delete active project",
    project_name_required: "Project name is required",
    project_name_too_long: "Project name is too long (max 100 characters)",
    project_already_exists: "Project with this name already exists",
    edit_project: "Edit project",
    current_project: "Current project",
    switch_project: "Switch project",
    set_as_active: "Set as active",
    switch_with_reload: "Switch",
    switch_and_reload_description: "Will reload PRs, labels and clear cache",
    switch_only_description: "Will only change configuration without reloading",
    delete_project_warning: "Warning! Deleting project",
    delete_project_warning_description:
      "This action is irreversible. All project data will be permanently deleted.",
    delete_confirmation_label: "Confirm deletion",
    delete_confirmation_help: "Type 'DELETE' to confirm project deletion",
    delete_confirmation_required: "You must type 'DELETE' to confirm deletion",
  },
};
